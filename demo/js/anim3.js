var PageControl = function(index){    
	...
	function start(){
		...
		startY = Number(touch.pageX);
		y = Number(touch.pageX);
		onOff = false;
	}
	function move(){
	...
	function end(){
			...
			if(moveY - startY>= 20){   
				...
				if(onOff2 == true){
					onOff2 = false;
					if(index ==0){  
						page[0].style.zIndex = "90";
						page[index].className = "anmoveRight";  
						...
						page[index].className = "anmoveRight";
						page[index].style.zIndex = "90";
						setTimeout(function(){
							page[index+1].style.display = "none";
							page[index+1].style.zIndex = "1";
						},800);
			...
			if(moveY - startY<=- 20){      
				if(onOff2){
					...
					if (index == total) {
						...
						page[index].style.display = "block";
						page[index].style.zIndex = "90";
						page[index].className = "anmoveLeft";
						setTimeout(function(){
							onOff2 = true;
							page[total].style.zIndex = "1";
							console.log(onOff2);
						},800);
					}else{
						joinArea = document.querySelector(".joinArea");
						...
						console.log(index);
						page[index+1].style.zIndex = "90";
						page[index+1].style.display = "block";
						page[index+1].className = "anmoveLeft";
						setTimeout(function(){
							onOff2 = true;
